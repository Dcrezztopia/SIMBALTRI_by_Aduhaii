...
<div class="card">
    ...
    <div class="card-body">
        <form>
            ...
            <div class="mb-3">
                <input type="text" class="form-control" id="input3" placeholder="Jenis Kelamin" value="{{ session('jenis_kelamin') }}" disabled>
            </div>
        ...
        <button class="btn btn-success mt-3" style="float: right;" onclick="redirectKeRiwayat()">
...
<script>
    function redirectKeRiwayat() {
        window.location.href = "{{ route('pelaporan.riwayat') }}";
    }
</script>
@endsection
