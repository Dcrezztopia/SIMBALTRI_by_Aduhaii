                    ...
                    <tr>
                        ...
                        <form action="{{ route('surat.updateStatus', ['id' => $surat->id_surat, 'status' => 'ditolak']) }}" method="POST" class="d-inline">
                            ...
                            <a href="{{ route('surat.detail', $surat->id_surat) }}" class="btn btn-sm btn-info"
                                data-bs-toggle="tooltip" title="Lihat detail surat"
                            >
                            <i class="bi bi-eye"></i>
                            </a>
                        <form action="{{ route('surat.destroy', $surat->id_surat) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus surat ini?');" class="d-inline">
                            @csrf
                            @method('DELETE')
